  ...
  return (
    <div className="page settings-page">
      ...
      <div className="settings-profile card">
        <div className="settings-avatar" role="img" aria-label="用户头像">
      ...
      <div className="settings-group">
        ...
        <div className="settings-group-card">
          <div className="setting-item">
            <div className="setting-icon blue" role="img" aria-label="外观图标">
          ...
          <div className="setting-item">
            <div className="setting-icon green" role="img" aria-label="隐私保护图标">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <button
              ...
              aria-label={settings.privacyMode ? '关闭隐私保护' : '开启隐私保护'}
          ...
          <div className="setting-item">
            <div className="setting-icon orange" role="img" aria-label="通知图标">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <button
              ...
              aria-label={settings.notification ? '关闭通知提醒' : '开启通知提醒'}
              aria-checked={settings.notification}
              role="switch"
            >
              <div className="mini-knob" />
            </button>
      ...
      <div className="settings-group">
        ...
        <div className="settings-group-card">
          <div className="setting-item">
            <div className="setting-icon purple" role="img" aria-label="精度图标">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <div className="setting-item">
            <div className="setting-icon blue" role="img" aria-label="速度图标">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <div className="settings-group">
        ...
        <div className="settings-group-card">
          <div className="setting-item">
            <div className="setting-icon orange" role="img" aria-label="关于图标">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
